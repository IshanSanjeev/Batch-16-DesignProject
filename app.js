...
window.addEventListener('load', ()=>{
    speak("Hi..");
    speak("I'm a virtual assistant. My name is Voice. I'm developed by Batch Fourteen");
    wishMe("");
})
...
function speakThis(message) {
    ...
    if(message.includes('hi') || message.includes('hello')) {
        ...
        const finalText = "I'm a virtual assistant. My name is Voice. I'm developed by Batch Fourteen. I can help you that you want. Still, I'm under devloping. I think, I'll be more powerful with Batch Fourteen. Thank You";
        speech.text = finalText;
    }

    else if(message.includes('how old are you')) {
        const finalText = "As I'm a virtual assistant, I've no age. But, i can say that I've started my journey from 05th april, 2024";
        speech.text = finalText;
    }
        ...
        const finalText = "Hey!! I'm Voice. I'm your personal virtual assistant.";
        speech.text = finalText;
    }
